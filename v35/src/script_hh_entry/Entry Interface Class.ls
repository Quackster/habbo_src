property pSwapAnimations, pEntryVisual, pSignSprList, pItemObjList, pBottomBar, pAnimUpdate, pUpdateTasks, pFirstInit, pViewMaxTime, pViewOpenTime, pViewCloseTime, pNewMsgCount, pNewBuddyRequests, pMessengerFlash, pInActiveIconBlend
...
on flashMessengerIcon me 
  ...
  if tWndObj <> 0 then
    ...
    tWndObj.getElement("messenger_icon_image").setProperty(#image, undefined.duplicate())
  end if
end
