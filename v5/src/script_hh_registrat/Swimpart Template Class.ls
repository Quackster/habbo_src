property pAction, pPart, pDirection, pActionLh, pActionRh, pmodel, pMemString, pCacheImage, pDrawProps, pXFix, pYFix, pCacheRectA, pCacheRectB, pSwimProps, pAnimation, pAnimFrame, pTotalFrame
