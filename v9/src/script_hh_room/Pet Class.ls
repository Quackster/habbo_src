property pGeometry, pXFactor, pSprite, pMatteSpr, pShadowSpr, pMember, pCanvasSize, pMemberNamePrefix, pInfoStruct, pName, pClass, pCustom, pLocX, pLocY, pLocH, pDirection, pSync, pPartList, pCorrectLocZ, pRestingHeight, pFlipList, pPartIndex, pIDPrefix, pScreenLoc, pAnimCounter, pEyesClosed, pTalking, pWaving, pSniffing, pMainAction, pMoving, pMoveStart, pMoveTime, pDestLScreen, pStartLScreen, pChanges, pDefShadowMem, pBuffer, pShadowFix, pAlphaColor, pUpdateRect, pPartClass
...
on define me, tdata 
  ...
  pMember.regPoint = point(0, pMember.height + pCanvasSize.getAt(4))
  pBuffer = pMember.duplicate()
...
on draw me, tRGB 
  ...
  pMember.draw(pMember.rect, [#shapeType:#rect, #color:tRGB])
end
...
on render me 
  ...
  if tFlip then
    pMember.regPoint = point(pMember.width, pMember.getProp(#regPoint, 2))
    pShadowFix = pXFactor
  ...
  pMember.copyPixels(pBuffer, pUpdateRect, pUpdateRect)
end
...
on getOffsetList me, tSize 
  ...
  if tSize = #large then
    ...
    tList = [:]
    tList.setAt("hd_std", [[21, -14], [21, -12], [21, -12], [19, -11], [19, -13]])
    tList.setAt("hd_sit", [[21, -14], [21, -12], [21, -12], [19, -10], [19, -11]])
    tList.setAt("hd_lay", [[21, -10], [21, -9], [21, -9], [19, -7], [19, -9]])
    tList.setAt("hd_slp", [[21, -9], [22, -8], [21, -8], [19, -6], [19, -8]])
    tList.setAt("hd_wlk", tList.getAt("hd_std"))
    tList.setAt("hd_pla", tList.getAt("hd_sit"))
    tList.setAt("hd_spc", tList.getAt("hd_std"))
    tList.setAt("hd_rdy", [[21, -12], [22, -9], [21, -7], [19, -9], [19, -12]])
    tList.setAt("hd_beg", [[15, -15], [15, -17], [16, -17], [19, -14], [19, -15]])
    tList.setAt("hd_ded", [[22, -5], [22, 4], [21, 6], [19, 7], [19, -7]])
    tList.setAt("hd_jmp_0", tList.getAt("hd_rdy"))
    tList.setAt("hd_jmp_1", tList.getAt("hd_sit"))
    tList.setAt("hd_jmp_2", [[21, -20], [23, -19], [21, -18], [19, -17], [19, -19]])
    tList.setAt("hd_jmp_3", [[21, -16], [22, -14], [21, -14], [19, -13], [19, -15]])
    tList.setAt("hd_scr_0", tList.getAt("hd_sit"))
    tList.setAt("hd_scr_1", [[20, -13], [22, -11], [21, -11], [19, -9], [19, -11]])
    tList.setAt("hd_scr_2", tList.getAt("hd_sit"))
    tList.setAt("hd_scr_3", tList.getAt("hd_scr_1"))
    tList.setAt("hd_bnd_0", tList.getAt("hd_rdy"))
    tList.setAt("hd_bnd_1", [[21, -15], [21, -13], [21, -13], [19, -11], [19, -14]])
    tList.setAt("hd_bnd_2", tList.getAt("hd_bnd_1"))
    tList.setAt("hd_bnd_3", tList.getAt("hd_bnd_1"))
    tList.setAt("tl_std", [[14, -8], [13, -9], [15, -13], [19, -14], [19, -8]])
    tList.setAt("tl_sit", [[12, -1], [13, -1], [16, -5], [19, -13], [19, -4]])
    tList.setAt("tl_lay", [[12, 1], [12, -1], [15, -8], [19, -11], [19, 0]])
    tList.setAt("tl_slp", tList.getAt("tl_lay"))
    tList.setAt("tl_wlk", tList.getAt("tl_std"))
    tList.setAt("tl_pla", tList.getAt("tl_sit"))
    tList.setAt("tl_spc", tList.getAt("tl_std"))
    tList.setAt("tl_rdy", [[14, -8], [13, -9], [15, -13], [19, -15], [19, -9]])
    tList.setAt("tl_beg", [[14, -1], [14, -1], [15, -5], [19, -10], [19, 1]])
    tList.setAt("tl_ded", [[15, 1], [12, 1], [15, -13], [19, -13], [19, -8]])
    tList.setAt("tl_jmp_0", tList.getAt("tl_rdy"))
    tList.setAt("tl_jmp_1", tList.getAt("tl_sit"))
    tList.setAt("tl_jmp_2", [[14, -11], [13, -12], [15, -16], [19, -17], [19, -11]])
    tList.setAt("tl_jmp_3", [[14, -13], [13, -14], [15, -17], [19, -20], [19, -13]])
    tList.setAt("tl_scr_0", tList.getAt("tl_sit"))
    tList.setAt("tl_scr_1", [[14, -1], [14, 0], [15, -5], [19, -12], [19, -1]])
    tList.setAt("tl_scr_2", tList.getAt("tl_sit"))
    tList.setAt("tl_scr_3", tList.getAt("tl_scr_1"))
    tList.setAt("tl_bnd_0", tList.getAt("tl_rdy"))
    tList.setAt("tl_bnd_1", [[15, -10], [15, -10], [16, -14], [19, -17], [19, -9]])
    tList.setAt("tl_bnd_2", tList.getAt("tl_bnd_1"))
    tList.setAt("tl_bnd_3", tList.getAt("tl_bnd_1"))
  end if
  return(tList)
