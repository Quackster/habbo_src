property pGeometry, pSprite, pMatteSpr, pShadowSpr, pExtraObjs, pCanvasSize, pMember, pPeopleSize, pInfoStruct, pName, pClass, pCustom, pDirection, pXFactor, pLocX, pLocY, pLocH, pHeadDir, pQueuesWithObj, pSync, pPreviousLoc, pPartList, pFlipList, pDancing, pMainAction, pPartIndex, pScreenLoc, pCtrlType, pTrading, pCarrying, pCurrentAnim, pAnimCounter, pEyesClosed, pSleeping, pTalking, pMoving, pMoveStart, pMoveTime, pDestLScreen, pStartLScreen, pWaving, pChanges, pDefShadowMem, pBuffer, pCorrectLocZ, pRestingHeight, pShadowFix, pBaseLocZ, pAlphaColor, pUpdateRect, pPartClass, pColors, pLastDir
