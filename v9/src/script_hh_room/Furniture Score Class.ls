...
on setScore me, tScore, tSpriteList 
  ...
  tSpriteList.getAt(3).width = undefined.width
  tSpriteList.getAt(3).height = undefined.height
  tSpriteList.getAt(4).width = undefined.width
  tSpriteList.getAt(4).height = undefined.height
