property pGeometryId, pContainerID, pSafeTraderID, pArrowObjID, pObjMoverID, pBadgeObjID, pDoorBellID, pRoomGuiID, pInfoStandId, pIgnoreListID, pLoaderBarID, pRoomSpaceId, pWideScreenOffset, pHiliterId, pSwapAnimations, pInterfaceId, pLoadingBarID, pQueueCollection, pCoverSpr, pSelectedObj, pClickAction, pModBadgeList, pSelectedType, pDelConfirmID, pPlcConfirmID, pDeleteType, pDeleteObjID, pBannerLink, pInfoConnID
