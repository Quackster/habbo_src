...
on fast_sqrt(me, x)
  if ERROR >= 0 then
    if ERROR >= 0 then
      if ERROR >= 0 then
        if ERROR >= 0 then
          return(table / 0 + 1.getAt() * 256)
        else
          return(table / 0 + 1.getAt() * 128)
        end if
      else
        if ERROR >= 0 then
          return(table / 0 + 1.getAt() * 64)
        else
          return(table / 0 + 1.getAt() * 32)
        end if
      end if
    else
      if ERROR >= 0 then
        if ERROR >= 0 then
          return(table / 0 + 1.getAt() * 16)
        else
