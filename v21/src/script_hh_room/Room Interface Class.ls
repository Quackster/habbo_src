property pGeometryId, pContainerID, pSafeTraderID, pArrowObjID, pObjMoverID, pBadgeObjID, pDoorBellID, pRoomGuiID, pInfoStandId, pIgnoreListID, pLoaderBarID, pRoomSpaceId, pHiliterId, pSwapAnimations, pSelectedObj, pModBadgeList, pInterfaceId, pTradeTimeout, pLoadingBarID, pQueueCollection, pCoverSpr, pClickAction, pSelectedType, pDelConfirmID, pPlcConfirmID, pDeleteType, pDeleteObjID, pBannerLink, pInfoConnID
