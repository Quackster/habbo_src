...
on mergeWindow me, tParentWndObj 
  ...
  if me.getPropRef(#pPageData, #localization).getAt(#texts).count >= 8 then
  ...
  if me.getPropRef(#pPageData, #localization).getAt(#texts).count >= 9 then
    if me.getPropRef(#pPageData, #localization).getAt(#texts).getAt(9) <> #empty then
      tFont = pWndObj.getElement("ctlg_txt1").getFont()
      tFont.setAt(#color, rgb(me.getPropRef(#pPageData, #localization).getAt(#texts).getAt(9)))
