...
on setTriggers me, tTriggerList 
  ...
  repeat while tTriggerList <= 1
    tTrigger = getAt(1, count(tTriggerList))
...
on setRestrictions me, tRestrictionList 
  ...
  repeat while tRestrictionList <= 1
    tRestriction = getAt(1, count(tRestrictionList))
...
on clearTriggers me, tForced 
  ...
  repeat while me.pTriggerList <= 1
    tTrigger = getAt(1, count(me.pTriggerList))
...
on clearRestrictions me, tForced 
  ...
  repeat while me.pRestrictionList <= 1
    tRestriction = getAt(1, count(me.pRestrictionList))
