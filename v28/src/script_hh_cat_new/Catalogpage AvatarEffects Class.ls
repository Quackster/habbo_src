...
on showPreview me, tOffer
  ...
  tCatalogProps = me.pPersistentCatalogData.getProps(tOffer[#offerList][1][#offername])
  ...
  repeat with i = 1 to me.pOfferTypesAvailable.count
    ...
    tText = me.getOfferPriceTextByType(tOffer[#offerList], me.pOfferTypesAvailable[i].getaProp(#type))
