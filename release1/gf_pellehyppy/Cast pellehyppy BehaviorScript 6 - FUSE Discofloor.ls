...
on fuseShow_setfloora me, num
  sprite(me.spriteNum).member.paletteRef = member(getmemnum("clubfloorparta" & num))
end

on fuseShow_setfloorb me, num
  sprite(me.spriteNum).member.paletteRef = member(getmemnum("clubfloorpartb" & num))
end
