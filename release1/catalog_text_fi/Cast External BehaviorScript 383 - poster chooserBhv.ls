...
on chooseItem me, tdata
  ...
  tSaveDelim = the itemDelimiter
  the itemDelimiter = ":"
  member("Selected poster name").text = tdata.item[6].word[1..tdata.item[6].word.count]
  pCurrentPosterCode = tdata.item[5].word[1..tdata.item[5].word.count]
  sprite(pImageSprite).member = member("leftwall poster" && tdata.item[1].word[1..tdata.item[1].word.count])
  sprite(pImageSprite).width = member("leftwall poster" && tdata.item[1].word[1..tdata.item[1].word.count]).width
  sprite(pImageSprite).height = member("leftwall poster" && tdata.item[1].word[1..tdata.item[1].word.count]).height
  the itemDelimiter = tSaveDelim
end
