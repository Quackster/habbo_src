...
on setOpponents me, data
  member("opponent.W").text = (("White:" & RETURN) & word 2 of data)
  member("opponent.B").text = (("Black:" & RETURN) & word 2 of data)
  member("chess.game_status").text = (((("White:" && word 2 of data) & RETURN) & "Black:") && word 2 of data)
