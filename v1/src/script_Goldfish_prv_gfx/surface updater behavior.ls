...
on update me
  ...
  patternName = item 1 of fieldData
  colorR = integer(item 3 of fieldData)
  colorG = integer(item 4 of fieldData)
  colorB = integer(item 5 of fieldData)
  if (shadowed = 1) then
  ...
  paletteName = item 2 of fieldData
