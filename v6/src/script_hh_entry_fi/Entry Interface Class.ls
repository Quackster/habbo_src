property pEntryVisual, pBottomBar, pSignSprList, pSignSprLocV, pUpdateTasks, pViewMaxTime, pViewOpenTime, pViewCloseTime, pFirstInit, pInActiveIconBlend, pMessengerFlash, pNewMsgCount, pNewBuddyRequests, pClubDaysCount
