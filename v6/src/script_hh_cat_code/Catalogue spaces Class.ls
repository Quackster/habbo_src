...
on setWallPaper me, ttype, tChange 
  ...
  repeat while pWallModel <= pWallPatterns.getProp(#line, pWallPattern)
    tid = getAt(pWallPatterns.getProp(#line, pWallPattern), pWallPatterns.getProp(#line, pWallPattern))
