property pEntryVisual, pSignSprList, pItemObjList, pBottomBar, pAnimUpdate, pUpdateTasks, pFirstInit, pNewMsgCount, pNewBuddyRequests, pViewMaxTime, pViewOpenTime, pViewCloseTime, pMessengerFlash, pInActiveIconBlend
