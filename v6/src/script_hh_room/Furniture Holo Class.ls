...
on update me
  ...
  if (pDelay = 0) then
    ...
    tNewNameB = ((tNameB.char[1] & pAnimFrm) & "_1")
    tNewNameC = ((tNameC.char[1] & pAnimFrm) & "_1")
...
on setHoloLight me
  ...
  tNewNameA = (tNameA.char[1] & pActive)
  tNewNameB = ((tNameB.char[1] & 0) & "_0")
  tNewNameC = ((tNameC.char[1] & 0) & "_0")
  tNewNameD = (tNameD.char[1] & pActive)
