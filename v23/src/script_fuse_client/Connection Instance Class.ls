property pMsgStruct, pXtra, pHost, pPort, pLogMode, pConnectionOk, pConnectionSecured, pDecoder, pEncoder, pConnectionShouldBeKilled, pEncryptionOn, pUnicodeDirector, pCommandsPntr, pListenersPntr, pDecipherOn, pLastContent, pD, pLogfield
