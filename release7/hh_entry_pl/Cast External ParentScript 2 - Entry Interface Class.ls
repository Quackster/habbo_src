property pEntryVisual, pBottomBar, pSignSprList, pSignSprLocV, pItemObjList, pUpdateTasks, pViewMaxTime, pViewOpenTime, pViewCloseTime, pAnimUpdate, pFirstInit, pInActiveIconBlend, pMessengerFlash, pNewMsgCount, pNewBuddyRequests, pClubDaysCount, pAnimCounter
...
on prepare me
  ...
  if pAnimUpdate then
    ...
    if pAnimCounter = 2 then
      repeat with tid in ["flag1", "flag2"]
        ...
        tMem = member(getmemnum("flag" & tNum))
        tSpr.member = tMem
