property pBgImages, pSpacing, pRefreshTimeoutId, pimage, pBgColor, pSelectedItem, pRotationQuad
...
on setTargetElement me, tElement, tScroll 
  ...
  me.pItemsPerRow = (me.pwidth / (pBgImages.getAt(#unselected).image.width + pSpacing))
