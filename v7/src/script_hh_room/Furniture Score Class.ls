...
on setScore me, tScore 
  ...
  me.getPropRef(#pSprList, 3).width = me.getPropRef(#pSprList, 3).member.width
  me.getPropRef(#pSprList, 3).height = me.getPropRef(#pSprList, 3).member.height
  me.getPropRef(#pSprList, 4).width = me.getPropRef(#pSprList, 4).member.width
  me.getPropRef(#pSprList, 4).height = me.getPropRef(#pSprList, 4).member.height
