property pChanges, pActive, pLastActive, pScifiDoorSpeed, pScifiDoorLocs, pScifiDoorTimer, pScifiDoorTimeOut, pDoubleClick
...
on SetScifiDoor me, tdir
  ...
  tMidSp2 = me.pSprList[3]
  if (tdir = "up") then
    tTopSp.locV = me.pScifiDoorLocs[1]
    tMidSp1.height = 65
    tMidSp2.height = 64
    tMidSp1.locV = me.pScifiDoorLocs[2]
    tMidSp2.locV = me.pScifiDoorLocs[3]
  else
    tTopSp.locV = (me.pScifiDoorLocs[1] + 57)
    tMidSp1.height = 8
    tMidSp2.height = 7
    tMidSp1.locV = (me.pScifiDoorLocs[2] - 2)
    tMidSp2.locV = (me.pScifiDoorLocs[3] + 5)
  end if
  me.pChanges = 0
