property pEntryVisual, pSignSprList, pCarObjList, pItemObjList, pNextCarUpdateTime, pBottomBar, pAnimUpdate, pAnimFrame, pUpdateTasks, pFirstInit, pViewMaxTime, pViewOpenTime, pViewCloseTime, pNewMsgCount, pNewBuddyRequests, pMessengerFlash, pInActiveIconBlend
...
on prepare me 
  ...
  if pAnimUpdate then
    ...
    if pAnimFrame = 3 then
      ...
      tMem = member(getmemnum("hh_au_fountain" & pAnimFrame))
    end if
    tSpr.member = tMem
