property pRegMsgStruct, pState, pCheckingName, pFigurePartListLoadedFlag, pAvailableSetListLoadedFlag, pParentEmailAddress, pAgeCheckFlag, pParentEmailNeededFlag
