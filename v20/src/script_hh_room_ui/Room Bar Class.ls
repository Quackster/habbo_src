property pTypingTimeoutName, pBottomBarId, pBouncerID, pNewMsgCount, pNewBuddyReq, pMessengerFlash, pTextIsHelpTExt, pFloodblocking, pFloodTimer, pFloodEnterCount, pPopupControllerID
